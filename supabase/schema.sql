...
-- Saves an order and all of its items as a single, all-or-nothing action, so
-- realtime listeners (like the Kitchen Display) can never see a half-created
-- order. Also looks up each item's current price/name itself, rather than
-- trusting the price sent by the browser.
-- ============================================================================

  ...
  return (
    <div className="min-h-screen bg-espresso flex items-center justify-center px-6">
      <form onSubmit={handleLogin} className="w-full max-w-sm bg-white rounded-card p-8 shadow-ticket">
        <div className="h-12 w-12 rounded-full bg-basil flex items-center justify-center mx-auto">
          <LayoutDashboard className="h-6 w-6 text-white" />
        </div>
        <h1 className="font-display text-2xl font-semibold text-center mt-4">Manager Login</h1>
        <p className="text-sm text-ink/50 text-center mt-1">Sign in to the admin dashboard</p>
        ...
        <Button type="submit" size="lg" className="w-full mt-6 bg-basil hover:bg-basil-light" disabled={loading}>
